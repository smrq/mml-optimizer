...
describe('validOctaves', function () {
	runCases('should convert {0} to {1}', opt.validOctaves, [
		...
		[opt.pitchToMidiNote('c', 0), [0]]
	]);
});

describe('relativePitch', function () {
	runCases('should convert {0} to {1}', opt.relativePitch, [
		[[67, 5], 'g'],
		[[68, 5], 'g+'],
		[[60, 5], 'c'],
		[[59, 5], 'c-'],
...
describe('parseMml', function () {
	runCases('should parse {0}', opt.parseMml, [
		['ccc', [
			{ type: 'note', midi: 60, ticks: 500, volume: 100 },
			{ type: 'note', midi: 60, ticks: 500, volume: 100 },
			{ type: 'note', midi: 60, ticks: 500, volume: 100 }
		]],
		['cdefgabCDEFGAB', [
			{ type: 'note', midi: 60, ticks: 500, volume: 100 },
			{ type: 'note', midi: 62, ticks: 500, volume: 100 },
			{ type: 'note', midi: 64, ticks: 500, volume: 100 },
			{ type: 'note', midi: 65, ticks: 500, volume: 100 },
			{ type: 'note', midi: 67, ticks: 500, volume: 100 },
			{ type: 'note', midi: 69, ticks: 500, volume: 100 },
			{ type: 'note', midi: 71, ticks: 500, volume: 100 },
			{ type: 'note', midi: 60, ticks: 500, volume: 100 },
			{ type: 'note', midi: 62, ticks: 500, volume: 100 },
			{ type: 'note', midi: 64, ticks: 500, volume: 100 },
			{ type: 'note', midi: 65, ticks: 500, volume: 100 },
		...
		['c#d#e#f#g#a#b#c+d+e+f+g+a+b+c-d-e-f-g-a-b-', [
			{ type: 'note', midi: 61, ticks: 500, volume: 100 },
			{ type: 'note', midi: 63, ticks: 500, volume: 100 },
			{ type: 'note', midi: 65, ticks: 500, volume: 100 },
			{ type: 'note', midi: 66, ticks: 500, volume: 100 },
			{ type: 'note', midi: 68, ticks: 500, volume: 100 },
			{ type: 'note', midi: 70, ticks: 500, volume: 100 },
			{ type: 'note', midi: 72, ticks: 500, volume: 100 },
			{ type: 'note', midi: 61, ticks: 500, volume: 100 },
			{ type: 'note', midi: 63, ticks: 500, volume: 100 },
			{ type: 'note', midi: 65, ticks: 500, volume: 100 },
			{ type: 'note', midi: 66, ticks: 500, volume: 100 },
			...
			{ type: 'note', midi: 70, ticks: 500, volume: 100 },
			{ type: 'note', midi: 72, ticks: 500, volume: 100 },
			{ type: 'note', midi: 59, ticks: 500, volume: 100 },
			{ type: 'note', midi: 61, ticks: 500, volume: 100 },
			{ type: 'note', midi: 63, ticks: 500, volume: 100 },
			{ type: 'note', midi: 64, ticks: 500, volume: 100 },
			{ type: 'note', midi: 66, ticks: 500, volume: 100 },
		...
		['c2c4c8c', [
			{ type: 'note', midi: 60, ticks: 1000, volume: 100 },
			{ type: 'note', midi: 60, ticks: 500, volume: 100 },
			{ type: 'note', midi: 60, ticks: 250, volume: 100 },
			{ type: 'note', midi: 60, ticks: 500, volume: 100 }
		]],
		['c2c2.c2..c2...', [
			{ type: 'note', midi: 60, ticks: 1000, volume: 100 },
			{ type: 'note', midi: 60, ticks: 1500, volume: 100 },
			{ type: 'note', midi: 60, ticks: 2250, volume: 100 },
			{ type: 'note', midi: 60, ticks: 3375, volume: 100 }
		]],
		['cc.c..c...', [
			{ type: 'note', midi: 60, ticks: 500, volume: 100 },
			{ type: 'note', midi: 60, ticks: 750, volume: 100 },
			{ type: 'note', midi: 60, ticks: 1125, volume: 100 },
			{ type: 'note', midi: 60, ticks: 1687, volume: 100 }
		]],
		...
		['L4.cc.c..c...', [
			...
			{ type: 'note', midi: 60, ticks: 1125, volume: 100 },
			{ type: 'note', midi: 60, ticks: 1687, volume: 100 },
			{ type: 'note', midi: 60, ticks: 2530, volume: 100 }
		]],
		['o2c>c>c<c<c', [
			{ type: 'octave', octave: 2 },
			{ type: 'note', midi: 24, ticks: 500, volume: 100 },
			{ type: 'octaveUp' },
			{ type: 'note', midi: 36, ticks: 500, volume: 100 },
			{ type: 'octaveUp' },
			{ type: 'note', midi: 48, ticks: 500, volume: 100 },
			{ type: 'octaveDown' },
			{ type: 'note', midi: 36, ticks: 500, volume: 100 },
			{ type: 'octaveDown' },
			{ type: 'note', midi: 24, ticks: 500, volume: 100 }
		...
		['v64ccc', [
			...
			{ type: 'note', midi: 60, ticks: 500, volume: 64 },
			{ type: 'note', midi: 60, ticks: 500, volume: 64 },
			{ type: 'note', midi: 60, ticks: 500, volume: 64 }
		]],
		['c&c&c', [
